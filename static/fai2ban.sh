...
tput clear
msg -bar
echo -e "\033[1;37mEste es Fail2ban Protection \033[1;33m0.10.3"
echo -e "\e[1;37mProtección contra ataques de DDOS"
msg -bar
if [[ ! -z "$pid_fail" ]]; then
 echo -e "${cor[2]} [1] >${cor[5]} $(fun_trans "Desinstalar Fail2ban")"
 echo -e "${cor[2]} [2] >${cor[5]} $(fun_trans "Ver el registro")"
 msg -bar
...
wget -O $HOME/fail2ban https://github.com/fail2ban/fail2ban/archive/0.10.3.tar.gz &> /dev/null
tar -xf $HOME/fail2ban &> /dev/null
cd $HOME/fail2ban-0.10.3 &> /dev/null
...
[[ -d $HOME/fail2ban-0.10.3 ]] && rm -rf $HOME/fail2ban-0.10.3

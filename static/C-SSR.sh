...
msg -bar
	stty erase '^H' && read -p "(Predeterminado: ADM-TYPHON):" ssr_user
	[[ -z "${ssr_user}" ]] && ssr_user="ADM-TYPHON"
...
msg -bar
	stty erase '^H' && read -p "(Predeterminado: ADM-TYPHON):" ssr_password
	[[ -z "${ssr_password}" ]] && ssr_password="ADM-TYPHON"
...
clear
	SSR_installation_status
	echo && echo -e "    ###Â¿Que desea realizar?###
$(msg -bar)

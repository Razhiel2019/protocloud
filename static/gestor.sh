...
echo -e " $(fun_trans "FECHA LOCAL NIC APLICADA!")"
}
...
msg -bar
while true; do
echo -e "${cor[3]} [1] > \033[1;37mACTUALIZAR VPS"
echo -e "${cor[3]} [2] > \033[1;37mREINICIAR SERVICIOS"
echo -e "${cor[3]} [3] > \033[1;37mREINICIAR VPS"
echo -e "${cor[3]} [4] > \033[1;37mCAMBIAR HOSTNAME VPS"
echo -e "${cor[3]} [5] > \033[1;37mCAMBIAR CONTRASEÑA ROOT"
echo -e "${cor[3]} [6] > \033[1;37mCAMBIAR HORA LOCAL MX"
echo -e "${cor[3]} [7] > \033[1;37mCAMBIAR HORA LOCAL ARG"
echo -e "${cor[3]} [8] > \033[1;37mCAMBIAR HORA LOCAL NIC"
echo -e "${cor[3]} [9] > \033[1;37mAGREGAR ROOT a GoogleCloud y Amazon \033[0m"
echo -e "${cor[3]} [0] > VOLVER"
while [[ ${opx} != @(0|[1-9]) ]]; do
msg -bar

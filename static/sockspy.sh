...
cd socks
patch="https://raw.githubusercontent.com/Razhiel2019/ADM_TYPHON/main/Install/backsocz"
arq="backsocz"
...
gettunel_fun () {
echo "master=ADM_TYPHON" > ${SCPinst}/pwd.pwd
...
pidproxy7=$(ps x | grep "proxy.py" | grep -v "grep" | awk -F "pts" '{print $1}') && [[ ! -z $pidproxy7 ]] && P7="\033[1;32m[ON] " || P7="\033[1;31m[OFF] "
msg -bar
...
echo -e "\e[1;97m >>>> WEBSOCKET SSL+PYTHON >>> $P7\e[0m"
echo -e "${cor[4]} [7] › \033[1;37m$(fun_trans  "PARAR TODOS SOCKS PYTHON")"

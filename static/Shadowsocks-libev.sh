...
tput clear
msg -bar
echo -e "\033[1;33m   › INSTALADOR SHADOWSOCK-LIBEV "
msg -bar
...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://www.dropbox.com/s/hbrjv9kwb5e4hms/instalador-shadowsocks-libev.sh > /dev/null 2>&1
